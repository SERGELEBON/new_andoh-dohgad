          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-card p-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <a href="/rendez-vous" className="btn-primary text-center">
                  Prendre rendez-vous
                </a>
                <a href="/documentation" className="btn-secondary text-center">
                  Acheter documentation
                </a>
                {profile?.role === 'coworking_client' && (
                  <a href="/co-working" className="btn-primary text-center sm:col-span-2">
                    Réserver un espace
                  </a>
                )}
              </div>
